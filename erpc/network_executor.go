...
func NewNetworkExecutor(
	...
	e := &networkExecutor{
		...
		upstreamGroup:                cfg.MatchUpstreamGroup,
		consensus:                    consensus,
		dynamicBlockUnavailableDelay: dynamicBlockUnavailableDelay,
	}
	if e.method == "" {
...
// MatchUpstreamGroup returns the configured upstream-group filter.
func (e *networkExecutor) MatchUpstreamGroup() string {
	if e == nil {
		return ""
	}
	return e.upstreamGroup
}
